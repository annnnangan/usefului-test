...
const buttonVariants = cva(
  'hi-im-elfo leading-6 font-semibold whitespace-nowrap rounded-lg ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed',
  {
    variants: {
      color: {
        primary:
